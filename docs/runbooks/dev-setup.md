...
- Optional: [gitleaks](https://github.com/gitleaks/gitleaks) for the local pre-push secret scan.
...
| Command           | Does                                                                                          |
| ----------------- | --------------------------------------------------------------------------------------------- |
| `pnpm check`      | lint + format + typecheck + test + codegen-clean. **What CI runs. Run it before committing.** |
